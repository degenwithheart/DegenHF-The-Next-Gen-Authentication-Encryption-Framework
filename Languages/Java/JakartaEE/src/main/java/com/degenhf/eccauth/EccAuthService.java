...
/**
 * ECC Authentication Service for Jakarta EE
 */
@ApplicationScoped
public class EccAuthService {
    ...
    @Inject
    @ConfigProperty(name = "degenhf.ecc.auth.hashIterations", defaultValue = "100000")
    private int hashIterations;

    @Inject
    @ConfigProperty(name = "degenhf.ecc.auth.tokenExpiry", defaultValue = "3600")
    private long tokenExpirySeconds;

    @Inject
    @ConfigProperty(name = "degenhf.ecc.auth.cacheSize", defaultValue = "10000")
    private long cacheSize;

    @Inject
    @ConfigProperty(name = "degenhf.ecc.auth.cacheTtl", defaultValue = "300")
