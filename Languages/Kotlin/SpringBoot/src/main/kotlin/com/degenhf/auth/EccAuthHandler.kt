...
class EccAuthHandler(
    ...
    init {
        ...
        logger.info("ECC Auth Handler initialized with cache TTL: ${options.cacheTtl}")
    }
        ...
        try {
            ...
            val claims = Jwts.parserBuilder()
                .setSigningKeyResolver { header, _ ->
                    ...
                    Keys.hmacShaKeyFor("demo-secret-key-change-in-production".toByteArray())
                }
                .build()
...
class CacheConfig {
    ...
    fun cacheManager(): CacheManager {
        return ConcurrentMapCacheManager("tokenCache")
    }
}